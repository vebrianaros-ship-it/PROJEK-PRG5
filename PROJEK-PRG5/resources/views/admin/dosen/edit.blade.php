    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h2 class="mb-1"><i class="fas fa-user-edit text-success"></i> Edit Dosen</h2>
                    <p class="text-muted mb-0">Edit data dosen {{ $dosen->nama }}</p>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('admin.dosen.show', $dosen) }}" class="btn btn-outline-secondary">
                        ...
                        <div class="card-header bg-white border-bottom">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-3">
                                    ...
                                    <small class="text-muted">Update data dosen dengan benar</small>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.dosen.update', $dosen) }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="form-text">
                                                ...
                                                NIP akan digunakan sebagai password default jika diubah
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="email" class="form-control @error('email') is-invalid @enderror" 
                                                id="email" name="email" value="{{ old('email', $dosen->user->email ?? '') }}" 
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select @error('pendidikan') is-invalid @enderror" id="pendidikan" name="pendidikan" required>
                                                ...
                                                <option value="S1" {{ old('pendidikan', $dosen->pendidikan) == 'S1' ? 'selected' : '' }}>
                                                    S1 - Sarjana
                                                </option>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                                <option value="1" {{ old('status', $dosen->status) == '1' ? 'selected' : '' }}>Aktif</option>
                                                <option value="0" {{ old('status', $dosen->status) == '0' ? 'selected' : '' }}>Tidak Aktif</option>
                                            </select>
                                            @error('status')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <div class="preview-card">
                                                ...
                                                <div class="preview-content">
                                                    ...
                                                    <div class="status-item">
                                                        ...
                                                        <span class="badge {{ $dosen->is_aa ? 'bg-success' : 'bg-warning' }} aa-status">
                                                            {{ $dosen->is_aa ? 'Academic Advisor' : 'Non-AA' }}
                                                        </span>
                                                    </div>
                                                    <div class="status-item">
                                                        <span class="status-label">Kelompok:</span>
                                                        <span class="text-muted">{{ $dosen->kelompok->count() }} kelompok</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="alert alert-success border-0 shadow-sm">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-3">
                                            ...
                                            <ul class="mb-0 small">
                                                <li>Perubahan NIP akan mengubah password default dosen</li>
                                                ...
                                                <li>Status tidak aktif akan menonaktifkan akses dosen</li>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3">
                                    <a href="{{ route('admin.dosen.show', $dosen) }}" class="btn btn-outline-secondary btn-lg">
                                        <i class="fas fa-times me-2"></i>Batal
                                    </a>
                                    <button type="submit" class="btn btn-success btn-lg">
                                        <i class="fas fa-save me-2"></i>Update Dosen
                                    </button>
                                </div>
                            </form>
                        </div>
